<%-- 
    Document   : upload
    Created on : Oct 30, 2015, 8:55:49 PM
    Author     : Kiran
--%>
    ...
    <body>
        ...
        <div class="container">
            <div class="page-header">
                <h1>jQuery File Upload Demo -- <a href="Checkfile" id="id-test">Test Link</a></h1>
            </div>
            <blockquote>
            ...
            <form id="fileupload" action="UploadServlet" method="POST" enctype="multipart/form-data">
                <input type="hidden" value="ABCD" name="COLPOSTID">
        ...
        <!--        <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.12.0/jquery.min.js"></script>
                ...
                <script src="js/jquery.fileupload-fp.js"></script>F
